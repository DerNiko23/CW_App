...
// Formular-Kontrolle, kein CTA: behaelt bewusst den scharfen System-Radius (rounded-sm) statt
// des globalen Button-rounded-full - Checked-State in Deep Teal (Ein-Akzent-Regel, DESIGN.md).
function Checkbox({
  className,
  ...props
